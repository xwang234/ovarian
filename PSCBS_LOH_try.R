...
PSCBS_allele=function(r,n.chunk,nsample)
{
  ...
  chunks<-c(seq(1,nsample,by=round(nsample/n.chunk)),nsample+1)
  ...
  fit <- segmentByPairedPSCBS(PSdata, knownSegments = knownSegments,preserveScale = FALSE, seed = 48879, verbose = -10)
...
res=mpi.parSapply(1:njob,FUN=PSCBS_allele,n.chunk=njob,nsample=nsample)
