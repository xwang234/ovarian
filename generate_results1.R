...
class_cat_copynumber=classify_platinum(data=data_class_copynumber,platform="copynumber_cat",selgenes=NULL,includeclinical=T)
...
data=drawroc_onselectedgenes(selgenes = selgenes,data=data_class_copynumber_hrgenes)
