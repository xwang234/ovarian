...
for (i in 1:6)
{
  ...
  png(paste0("/fh/fast/dai_j/CancerGenomics/Ovarian_Cancer/result/tmp/manhplot_fdr",i,".png"))
  draw_manhattan(fdrs=fdrs,fdrthreshold=0.05,maxy=6,chrs=NULL,keepres=F,logscale=T,main=i)
  dev.off()
}
